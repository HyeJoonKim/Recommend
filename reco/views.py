...
class Recommend(View):
    def post(self, request):
        ...
        print(category)
        if category == 'IT 모바일':
            csv_file = pd.read_csv('D:\\tool\\final\\csv\\IT 모바일_YES베스트.csv')
        elif category == '경제 경영':
            csv_file = pd.read_csv('D:\\tool\\final\\csv\\경제 경영_YES베스트.csv')
        elif category == '역사':
            csv_file = pd.read_csv('D:\\tool\\final\\csv\\역사_YES베스트.csv')
        elif category == '자연과학':
            csv_file = pd.read_csv('D:\\tool\\final\\csv\\자연과학_YES베스트.csv')
        elif category == '소설_시_희곡':
            csv_file = pd.read_csv('D:\\tool\\final\\csv\\소설_시_희곡_YES베스트.csv')
        elif category == '사회 정치':
            csv_file = pd.read_csv('D:\\tool\\final\\csv\\사회 정치_YES베스트.csv')
        elif category == '만화_라이트노벨':
            csv_file = pd.read_csv('D:\\tool\\final\\csv\\만화_라이트노벨_YES베스트.csv')
